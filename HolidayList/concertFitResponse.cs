...
//
//    using ConcertFitResponse;
//
//    var concertFit = ConcertFit.FromJson(jsonString);

namespace ConcertFitResponse
{
    using System;
    ...
    public partial class ConcertFit
    {
        [JsonProperty("artist")]
    ...
    public partial class ConcertFit
    {
        public static ConcertFit[] FromJson(string json) => JsonConvert.DeserializeObject<ConcertFit[]>(json, ConcertFitResponse.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ConcertFit[] self) => JsonConvert.SerializeObject(self, ConcertFitResponse.Converter.Settings);
    }
